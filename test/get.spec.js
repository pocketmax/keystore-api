...
describe('get a key/val', function(){

	it('should pass with a pre-existing value', function(done){
...
describe('get a nested key/val', function(){
	...
	it('should fail with a unknown key', function(done){

		request(app)
		.get('/asdfasdf/asd/asd/fasd/sd/sd/sdsdf')
		.expect(404)
		.expect('content-type', /json/)
		.end(done);
